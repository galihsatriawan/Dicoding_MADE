...
import id.shobrun.consumer.viewmodels.MovieWishListViewModel;
import id.shobrun.consumer.views.DetailMovieWishListActivity;
...
public class MovieWishListFragment extends Fragment implements IConsumerWishlistMovieView {
    ...
    public static MovieWishListFragment getInstance() {
        if(INSTANCE==null){
            synchronized (MovieWishListFragment.class){
                if(INSTANCE==null){
