...
import id.shobrun.consumer.viewmodels.DetailMovieWishListViewModel;
import id.shobrun.consumer.views.iview.IDetailMovieWishListView;

public class DetailMovieWishListActivity extends AppCompatActivity implements IDetailMovieWishListView {
    ...
    private FrameLayout menuWishList;
    private ImageView iconWishList;
    ...
    private DetailMovieWishListViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_movie_wish_list);
        initUI();
        initViewModel();
        showActionBar();
    ...
    public void initViewModel(){
        viewModel = ViewModelProviders.of(this).get(DetailMovieWishListViewModel.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        iconWishList = rootView.findViewById(R.id.ic_favorite);
        if(mMovie!=null){
    ...
    private void isWishList(){
        Log.d(TAG, "isWishList: "+mMovie);
    ...
    public void showDetailMovie(Movie movie) {
        ...
        if(movie.getTags()!=null && iconWishList!=null){
            if(movie.getTags().contains(Constants.TAGS_WISHLIST)) {
                setIconWishList(R.drawable.ic_bookmark_white_24dp);
            }
    ...
    @Override
    public void setIconWishList(int res) {
        iconWishList.setImageResource(res);
    }
