package id.shobrun.consumer.repositories.local;
...
import id.shobrun.consumer.utils.DataPair;
import id.shobrun.consumer.utils.Helper;
...
public class ConsumerMovieLocalData implements IConsumerMovieDataSource.DBSource {
    ...
    private static class QueryAsyncTask extends AsyncTask<DataPair, Void, List<Movie>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            IConsumerMovieDataSource.DBSource.LoadDataCallback listener = weakCallback.get();
            if(listener!=null){
                listener.onPreLoad();
            }
    ...
    private static class UpdateAsyncTask extends  AsyncTask<DataPair, Void, Integer>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            IConsumerMovieDataSource.DBSource.UpdateDataCallback listener = weakCallback.get();
            if(listener!=null){
