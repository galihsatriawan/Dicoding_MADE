...
import id.shobrun.consumer.utils.common.OnItemClickListener;

public class MovieWishListAdapter extends RecyclerView.Adapter<MovieWishListAdapter.MovieWishListViewHolder> {
    ...
    @NonNull
    @Override
    public MovieWishListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        return new MovieWishListViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_movie_wishlist,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull MovieWishListViewHolder viewHolder, int position) {
    ...
    class MovieWishListViewHolder extends RecyclerView.ViewHolder implements IMovieWishListItemView{
        private TextView tvTitle,tvExcerpt,tvRating;
        private ImageView imgPoster,imgWishlistOff,imgWishlistOn;
        MovieWishListViewHolder(@NonNull View view) {
            super(view);
